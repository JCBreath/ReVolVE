...
def config_parser(cmd=None):
    ...
    parser.add_argument('--model_name', type=str, default='ReVolVE',
                        choices=['ReVolVE'])
    ...
    # model
    # volume options
    parser.add_argument("--n_lamb", type=int, action="append")
    ...
    parser.add_argument("--smooth_list", type=int, default=None, action="append")
